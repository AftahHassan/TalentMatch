...
Enforce that the TalentMatch AI agent always calls a real tool to fetch data before answering, preventing hallucinated scores, skills, or recommendations.
